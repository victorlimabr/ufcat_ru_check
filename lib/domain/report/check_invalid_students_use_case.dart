...
class CheckInvalidStudentsUseCase
  ...
  Future<List<Entry>> perform(List<Sheet> input) async {
    ...
    final studentIds = students.map((student) => student.id);
    return entries
